                ...
                <nav id="primary-menu" class="style-2 center">
                    <div class="container clearfix">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:void(0)"><div>CASTIGLIONCELLO<i class="icon-chevron-down"></i></div></a>
                                  <ul>
                            ...
                            <li><a href="javascript:void(0)"><div><?php echo AFFITTO;?><i class="icon-chevron-down"></i></div></a>
                                <ul>
