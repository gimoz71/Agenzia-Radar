...
$desPrezzo=array(
        ...
        'fissato'=>'Fissato a',
        'privata'=>'trattativa privata',
        'agenzia'=>'Informazioni e costi in agenzia'
);
$affitto='affitto';
$vendita='vendita';
$desCategorie=array(
...
define('SERVIZI','I SERVIZI');
define('PROPOSTE','IMMOBILI IN VENDITA');
...
define('AGENZIA_FOOTER',"L'Agenzia");
define('SERVIZI_FOOTER','I Servizi');
define('PROPOSTE_FOOTER','Immobili in Vendita Castiglioncello');
define('VACANZE_FOOTER','Affitto Case Vacanze Castiglioncello');
define('RESIDENCE_FOOTER','Affitto Residence Castiglioncello');
define('DINTORNI_FOOTER','I Dintorni Castiglioncello');
define('INFORMAZIONI_FOOTER','Dove Siamo');               
define('CONTATTI_FOOTER','Contatti');          
define('LINK_FOOTER','Meteo Webcam');    
define('PAGAMENTI_FOOTER','Pagamenti');
define('RESIDENCESULMARE_FOOTER','Residence sul mare Castiglioncello');
...
define('IMMOBILI','immobili');
define('RESIDENCE','residence');
define('LAST_MINUTE','last minute');
define('POSTI_LETTO','Posti letto');
define('APPARTAMENTI','Tipologie di appartamenti');

/*Campi form*/
define('NOME','Nome');
define('COGNOME','Cognome');
define('TELEFONO','Telefono');
define('CELLULARE','Cellulare');
define('STATO','Stato');
define('CITTA','Citt&agrave;');
...
define('KEY_IMMOBILE','immobile');
define('KEY_RESIDENCE','residence');
define('KEY_LAST','offerte, last minute');

/*Titoli*/
define('DETTAGLI','Vai ai dettagli');
define('RICERCA','Ricerca avanzata');
define('IMMO','Immobili in vendita');
define('RES','Residence ed appartamenti per vacanze  settimanali');
define('CAS','Case per le vacanze');
define('OFF','Offerte e Last Minute');
define('ESTATE','Estate');
define('ESTATE_LOC','Immobili in locazione ');
define('LISTA','Lista');
define('VENDITA','Vendita');
define('AFFITTO','Affitto');
define('PROP_VACANZE','Altre proposte per le vacanze');

/*Ricerca*/
define('TIPO','Tipologia');
define('PREZZO','Prezzo');
define('FINO','fino a');
define('OLTRE','oltre');
define('CONTRATTO','Contratto');
define('CERCA','Cerca');
define('NOIMMO','Non sono stati trovati immobili con i parametri scelti');
define('CATEGORIA_IMMO','Categoria immobile');
define('LOCALITA','Località');
define('RIC_RESIDENZIALE','Residenziale');
define('RIC_COMMERCIALE','Commerciale');
define('RIC_BARCA','Posto barca');
...
define('DISPONIBILE','Disponibile');
define('NON_DISPONIBILE','Non disponibile');
...
define('TITOLO_BASE_INDEX','Case in affitto vendita castiglioncello Agenzia immobiliare Radar Castiglioncello affitti estivi castiglioncello - Livorno Toscana');

define('DESCRIZIONE_INDEX','affitti estivi a castiglioncello Agenzia immobiliare Radar, esperti nel settore immobiliare da 35 anni, sono a disposizione per l\' acquisto e vendita di immobili, gestione di residence, appartamenti, ville per vacanze - consulenze gratuite');

define('KEY_INDEX','Agenzia, Radar, immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi, Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte, affitti estivi castiglioncello');


define('TITOLO_INDEX','BENVENUTI SU AGENZIARADAR.IT');  
...
define('TITOLO_BASE_DOVE','Agenzia immobiliare Radar Castiglioncello - Livorno Toscana');

define('DESCRIZIONE_DOVE','Agenzia immobiliare Radar, esperti nel settore immobiliare da 35 anni, sono a disposizione per l\' acquisto e vendita di immobili, gestione di residence, appartamenti, ville per vacanze - consulenze gratuite');

define('KEY_DOVE','Agenzia, Radar, immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,¬†Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte');
...
define('TITOLO_BASE_CHISIAMO','Chi Siamo Agenzia immobiliare Radar Castiglioncello - case in vendita a castiglioncello Residence castiglioncello');

define('DESCRIZIONE_CHISIAMO','Agenzia immobiliare Radar, Residence castiglioncello');

define('KEY_CHISIAMO','Residence castiglioncello, immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte');
...
define('TITOLO_BASE_INDEX','residence castiglioncello Affitti estivi  Livorno Toscana - Residence castiglioncello toscana mare');

define('DESCRIZIONE_INDEX','residence castiglioncello affitti estivi castiglioncello , Residence castiglioncello case per le vacanze e posti barca acquisto e vendita di immobili, gestione di residence, appartamenti, ville per vacanze - consulenze gratuite');

define('KEY_INDEX','affitti estivi, residence castiglioncello, Agenzia immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,¬†Toscana, Livorno, Rosignano Marittimo, offerte');
...
define('TITOLO_BASE_INTORNO','Affitti estivi residence castiglioncello   Livorno Toscana Residence castiglioncello  mare');

define('DESCRIZIONE_INTORNO','residence castiglioncello affitti estivi castiglioncello , Residence castiglioncello case per le vacanze e posti barca acquisto e vendita di immobili, gestione di residence, appartamenti, ville per vacanze - consulenze gratuite');

define('KEY_INTORNO','affitti estivi, residence castiglioncello, Agenzia immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,¬†Toscana, Livorno, Rosignano Marittimo, offerte');
...
define('TITOLO_BASE_SERVIZI','Agenzia immobiliare Radar Castiglioncello Residence castiglioncello - Livorno Toscana');

define('DESCRIZIONE_SERVIZI','Agenzia immobiliare Radar, esperti nel settore immobiliare da 35 anni, sono a disposizione per l\' acquisto e vendita di immobili, gestione di residence, appartamenti, ville per vacanze Residence castiglioncello');

define('KEY_SERVIZI','Residence castiglioncello, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,¬†Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte');
...
define('TITOLO_BASE_ERROR',' 404 Error Page - Agenzia immobiliare Radar Residence castiglioncello Livorno Toscana');

define('DESCRIZIONE_SERVIZI','Agenzia immobiliare Radar, esperti nel settore immobiliare da 35 anni, sono a disposizione per l\' acquisto e vendita di immobili, gestione di residence, appartamenti, ville per vacanze - consulenze gratuite');

define('KEY_SERVIZI','Agenzia, Radar, immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,¬†Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte');
...
define('TITOLO_RESIDENCE','SPECIALIZZATI PER LE VOSTRE VACANZE');    

define('CONTENUTORESIDENCE','


L\'Agenzia Radar, esperta nel settore turistico della rinomata Castiglioncello, da anni si occupa di organizzare al meglio le vostre vacanze al mare nella regione Toscana. Il nostro intento è la ricerca del miglior appartamento in residence o villetta che al meglio possa soddisfare le esigenze delle famiglie che vogliono trascorrere le vacanze al mare.  Tra le soluzioni offerte, Vi proponiamo,  appartamenti, villette con giardino, ville vicine al mare, mono, bilocali e trilocali in residences ed altro. Le  strutture ricettive ed i residence proposti si adattano a tutte le esigenze delle famiglie che vogliono trovare il meglio anche ad un prezzo low-cost, senza rinunciare ai comfort  dei vari servizi  offerti come : - piscina, vicinanza mare, garage privato, posto auto riservato,terrazza con vista mare,balcone, giardino.  Dotati di: -   lavatrice, tv, lavastoviglie, aria condizionata. Castigliocello offre la  possibilità di noleggio barche, lezioni di vela per la vicinanza al Circolo Nautico al  Marina Cala de\' Medici ed Circolo Velico Pietrabianca, noleggio auto, immersioni subacquee al  diving center presso il circolo il Chioma o il marina cala de\' Medici, Tennis, equitazione,  ombrellone, lettino e sdraio presso i vari stabilimenti  balneari della zona . ');
...
define('TITOLO_BASE_RESIDENCE2',' Residence castiglioncello e le tue case per la vacanza in toscana - affitti estivi castiglioncello');

define('DESCRIZIONE_RESIDENCE2','Residence castiglioncello case vacanza sul mare con piscina in toscana a Castiglioncello nella costa degli etruschi, affitti estivi castiglioncello');

define('KEY_RESIDENCE2','Residence castiglioncello, immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, affitti estivi castiglioncello, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte');



define('TITOLO_RESIDENCE2','SPECIALIZZATI PER I RESIDENCE E CASE SUL MARE PER LE VOSTRE VACANZE A CASTIGLIONCELLO');    
...
L\'Agenzia Radar, esperta nel settore turistico della rinomata Castiglioncello, da anni si occupa di organizzare al meglio le vostre vacanze al mare nella regione Toscana. Il nostro intento è la ricerca del miglior appartamento in residence o villetta che al meglio possa soddisfare le esigenze delle famiglie che vogliono trascorrere le vacanze al mare.  Tra le soluzioni offerte, Vi proponiamo,  appartamenti, villette con giardino, ville vicine al mare, mono, bilocali e trilocali in residences ed altro. Le  strutture ricettive ed i residence proposti si adattano a tutte le esigenze delle famiglie che vogliono trovare il meglio anche ad un prezzo low-cost, senza rinunciare ai comfort  dei vari servizi  offerti come : - piscina, vicinanza mare, garage privato, posto auto riservato,terrazza con vista mare,balcone, giardino.  Dotati di: -   lavatrice, tv, lavastoviglie, aria condizionata. Castigliocello offre la  possibilità di noleggio barche, lezioni di vela per la vicinanza al Circolo Nautico al  Marina Cala de\' Medici ed Circolo Velico Pietrabianca, noleggio auto, immersioni subacquee al  diving center presso il circolo il Chioma o il marina cala de\' Medici, Tennis, equitazione,  ombrellone, lettino e sdraio presso i vari stabilimenti  balneari della zona .
 ...
 Pagamenti con carta di credito, pagamenti on-line. Vi aspettiamo per accogliervi in uno dei nostri residence sul mare in Toscana.
  ');

/*PRIVACY E DISCLAIMER */


define('TITOLO_BASE_PRIVACY','Residence castiglioncello e le tue case per la vacanza in toscana - affitti estivi castiglioncello');

define('DESCRIZIONE_PRIVACY','Residence case vacanza sul mare con piscina in toscana a Castiglioncello nella costa degli etruschi, affitti estivi castiglioncello');

define('KEY_PRIVACY','Agenzia, Radar, immobiliare, residence, residences, appartamenti, villa, ville, Castiglioncello, vacanze, affitti estivi castiglioncello, estate, mare, bilocale, monolocale, trilocale, consulenza gratuita, stime, casa, posto barca, costa degli etruschi,Toscana, casa vacanze, casa al mare, villa al mare, residence sul mare, posti barca, costa degli etruschi, Livorno, Rosignano Marittimo, offerte');



define('TITOLO_PRIVACY','LEGGE PRIVACY E DISCLAIMER');    
...
L\'Agenzia immobiliare RADAR garantisce che ogni informazione fornita a fini promozionali o di contatto verrà trattata in conformità al Decreto LGS. 196/2003.
La Dig.it Solution comunica inoltre che ai sensi del decreto Lgs. 196/2003 i dati degli utenti forniti al momento della sottoscrizione dell\'ordine di acquisto e/o della compilazione della fattura sono esclusi dal consenso dell\'interessato in quanto raccolti in base agli obblighi fiscali/tributari previsti dalla legge, dai regolamenti e dalla normativa comunitaria e, in ogni caso, al solo fine di consentire degli obblighi derivanti dal contratto di acquisto cui è parte interessato e/o per l\'acquisizione delle necessarie informative contrattuali sempre ed esclusivamente attivate su richiesta di quest\'ultimo (Art. 24, lett. a e b, decreto legislativo 196/2003).
Richiesta di cancellazione dati personali.
I dati personali sono raccolti con la finalità di registrare il Cliente ed attivare nei suoi confronti le procedure per l\'esecuzione del presente contratto e le relative necessarie comunicazioni; tali dati sono trattati elettronicamente nel rispetto delle leggi vigenti e potranno essere esibiti soltanto su richiesta della autorità giudiziaria ovvero di altre autorità per leggi autorizzante. L\'interessato gode dei diritti di cui all\'art. 7 d. lgs. 196/2003, e cioè: di chiedere conferma della esistenza presso la sede della Dig.it Solution dei propri dati personali; di conoscere la loro origine, la logica e le finalità del loro trattamento; di ottenere l\'aggiornamento, la rettifica, e la integrazione; di chiederne la cancellazione, la trasformazione in forma anonima o il blocco in caso di trattamento illecito; di opporsi al loro trattamento per motivi legittimi o nel caso di utilizzo dei dati per invio di materiale pubblicitario, informazioni commerciali, ricerche di mercato, di vendita diretta e di comunicazione commerciale interattiva.
L\'ottenimento della cancellazione dei propri dati personali è subordinato all\'invio di una comunicazione scritta inviata tramite fax (0586 759935) o spedizione postale alla sede della società.
Titolare alla raccolta e trattamento dei dati personali è Agenzia Radar Immobiliare di Giorgio Costagli - Via Aurelia, 548 - 57016 Castiglioncello (LI).<br><br>

<strong>DISCLAIMER</strong><br><br>


Il sito www.agenziaradar.it  e quelli ad essi associati sono di proprietà di Agenzia Radar di Giorgio Costagli. La veste grafica, le immagini ed i testi presenti nel sito sono soggetti a copyright dei siti o dei rispettivi proprietari e non possono essere riprodotti o trasmessi con nessun mezzo, né essere utilizzati in ambito professionale o commerciale senza autorizzazione scritta.
 ');

/* WEBCAM */

define('TITOLO_BASE_WEBCAM',' WEBCAM E METEO case per la vacanza in toscana - affitti estivi castiglioncello e Residence castiglioncello');

define('DESCRIZIONE_WEBCAM','Residence castiglioncello case vacanza sul mare con piscina in toscana a Castiglioncello nella costa degli etruschi, affitti estivi castiglioncello');
...
define('LUGLIO','Luglio');
define('MAGGIO','Maggio');
define('GIUGNO','Giugno');
define('AGOSTO','Agosto');
define('SETTEMBRE','Settembre');
define('GENNAIO','Gennaio');                              
define('FEBBRAIO','Febbraio');                             
define('MARZO','Marzo');                                   
define('APRILE','Aprile');           
define('OTTOBRE','Ottobre');
define('NOVEMBRE','November');
define('DICEMBRE','Dicembre');

define('LISTINO','Prezzi e disponibilità');
define('NOTE_ALTRO_PERIODO','Su richiesta');
define('ALTRO_PERIODO','Altri periodi');
define('PERIODO','Periodo');
define('VAC_SETT','Vacanza settimanale (Sabato/Sabato)');
define('VAC_MENS','Vacanza lunga (mensile/min 15gg)');

define('PAGINA_LAVORAZIONE','PAGINA IN LAVORAZIONE');
define('PRENOTA','Prenota');


/* aggiunto da tommaso vietina */
/* help ricerca */
define('RICPOPUNO','Vacanza settimanale - In questa sezione puoi prenotare residence ed appartamenti con la formula settimanale ( in alta stagione sabato/sabato). Se non trovi ciò che cerchi ,visita  anche la sezione vacanza lunga a PREZZI VANTAGGIOSI (i periodi vanno dal 1 al 15 o  dal 16 al 31  di ogni mese o  1/31).');
define('RICPOPDUE','Vacanza lunga - In questa sezione puoi prenotare case ed appartamenti  minimo per 15 gg. ( I periodi vanno dal 1 al 15 o  dal 16 al  31 di ogni mese oppure dal 1 al 31). Se non trovi ciò che cerchi visita anche la sezione vacanza settimanale ci sono moltissime altre offerte con la formula sabato/sabato.');


/*BANNER*/
define('BANNERH','style="background-image:url(../images/banner.png);"');
define('BANNERP','style="background-image:url(../images/banner-vacanza-lunga-it.png);"');
define('BANNERP_DUE','style="background-image:url(../images/banner-vacanza-settimanale-it.png);"');



define('RISULTATI_VACANZA_LUNGA','Sei nella sezione:VACANZA LUNGA - RISULTATI DELLA TUA RICERCA:');
define('RISULTATI_VACANZA_CORTA','Sei nella sezione:VACANZA SETTIMANALE - RISULTATI DELLA TUA RICERCA:');
