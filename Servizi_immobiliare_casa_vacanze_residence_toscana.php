...
$titolo=TITOLO_BASE_SERVIZI;
$descrizione=DESCRIZIONE_SERVIZI;
$keywords=KEY_SERVIZI;
$menu['servizi']='class="selezionato"';
?>
<!DOCTYPE html>
	...
	<?php include INCLUDEPATH.'testata.php';?>
        ...
        <section id="page-title">
            ...
            <div class="container clearfix">
                <h1><?=TITOLO_SERVIZI?></h1>
                <ol class="breadcrumb">
                    <li><a href="<?=TOTALPATH?>">Home</a></li>
                    <li class="active"><?=TITOLO_SERVIZI?></li>
                </ol>
            </div>
